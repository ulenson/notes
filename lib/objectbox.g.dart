...
final _entities = <ModelEntity>[
  ModelEntity(
      ...
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 2521007911644802013),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8829738501445174015),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2579636614231272094),
            name: 'description',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 7589793220805295044),
